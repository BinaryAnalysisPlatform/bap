...
(* OASIS_START *)
(* DO NOT EDIT (digest: d78f4397135fa035b2fc16bf9bc83662) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          sections =
            [
               Flag
                 ({
                     cs_name = "serialization";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      flag_description =
                        Some "\"Build serialization library\"";
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "bap-types";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Conceval"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "bap_types";
                      lib_findlib_name = Some "conceval";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.EFlag "serialization", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = ".";
                      bs_compiled_object = Best;
                   ...
                   {
                      lib_modules = ["Bil_piqi"; "Stmt_piqi"; "Stmt_piqi_ext"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "bap_types";
                      lib_findlib_name = Some "serialization";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Bap_install_printers"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "bap_types";
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\252\161M\184\006c\243\174\r\012m?\243\026t\229";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
