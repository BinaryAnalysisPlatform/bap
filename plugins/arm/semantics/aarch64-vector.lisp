...
(defmacro LDPvec*i (vn vm base imm size scale)
...
(defun LDPQi (qn qm base imm) (LDPvec*i qn qm base imm 128 4))
(defun LDPDi (qn qm base imm) (LDPvec*i qn qm base imm 64 3))
(defun LDPSi (qn qm base imm) (LDPvec*i qn qm base imm 32 2))
...
(defun LDURSi (st base simm) (LDURvec*i st base simm 32))
(defun LDURDi (dt base simm) (LDURvec*i dt base simm 64))
(defun LDURQi (qt base simm) (LDURvec*i qt base simm 128))
